<template>
    <div class="row justify-content-center testimonial_slider testimonial_style1 carousel_slide3 owl-carousel owl-theme owl-loaded owl-drag" data-margin="30" data-loop="true" data-autoplay="true" data-dots="true">
