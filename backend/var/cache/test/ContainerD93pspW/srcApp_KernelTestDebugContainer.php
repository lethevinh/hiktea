...
class srcApp_KernelTestDebugContainer extends Container
{
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_d7828985209bf1824b4c244b5bcbefe0bd93b5f9c7520946343c8f01e634fa11');
    ...
    protected function getSerializerService()
    {
        ...
        return $this->services['serializer'] = new \Symfony\Component\Serializer\Serializer([0 => $a, 1 => ($this->privates['api_platform.hydra.normalizer.constraint_violation_list'] ?? $this->getApiPlatform_Hydra_Normalizer_ConstraintViolationListService()), 2 => ($this->privates['api_platform.problem.normalizer.constraint_violation_list'] ?? $this->getApiPlatform_Problem_Normalizer_ConstraintViolationListService()), 3 => $a, 4 => ($this->privates['api_platform.hydra.normalizer.collection_filters'] ?? $this->getApiPlatform_Hydra_Normalizer_CollectionFiltersService()), 5 => ($this->privates['api_platform.hydra.normalizer.documentation'] ?? $this->getApiPlatform_Hydra_Normalizer_DocumentationService()), 6 => ($this->privates['api_platform.hydra.normalizer.entrypoint'] ?? $this->getApiPlatform_Hydra_Normalizer_EntrypointService()), 7 => ($this->privates['api_platform.hydra.normalizer.error'] ?? $this->getApiPlatform_Hydra_Normalizer_ErrorService()), 8 => ($this->privates['api_platform.problem.normalizer.error'] ?? ($this->privates['api_platform.problem.normalizer.error'] = new \ApiPlatform\Core\Problem\Serializer\ErrorNormalizer(true))), 9 => ($this->privates['serializer.normalizer.json_serializable'] ?? ($this->privates['serializer.normalizer.json_serializable'] = new \Symfony\Component\Serializer\Normalizer\JsonSerializableNormalizer())), 10 => ($this->privates['serializer.normalizer.datetime'] ?? ($this->privates['serializer.normalizer.datetime'] = new \Symfony\Component\Serializer\Normalizer\DateTimeNormalizer())), 11 => ($this->privates['serializer.normalizer.constraint_violation_list'] ?? $this->getSerializer_Normalizer_ConstraintViolationListService()), 12 => ($this->privates['serializer.normalizer.dateinterval'] ?? ($this->privates['serializer.normalizer.dateinterval'] = new \Symfony\Component\Serializer\Normalizer\DateIntervalNormalizer())), 13 => ($this->privates['serializer.normalizer.data_uri'] ?? $this->getSerializer_Normalizer_DataUriService()), 14 => ($this->privates['App\\Serializer\\UserNormalizer'] ?? $this->getUserNormalizerService()), 15 => ($this->privates['api_platform.serializer.normalizer.item'] ?? $this->getApiPlatform_Serializer_Normalizer_ItemService()), 16 => ($this->privates['api_platform.jsonld.normalizer.object'] ?? $this->getApiPlatform_Jsonld_Normalizer_ObjectService()), 17 => ($this->privates['serializer.denormalizer.array'] ?? ($this->privates['serializer.denormalizer.array'] = new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer())), 18 => ($this->privates['serializer.normalizer.object'] ?? $this->getSerializer_Normalizer_ObjectService())], [0 => ($this->privates['serializer.encoder.xml'] ?? ($this->privates['serializer.encoder.xml'] = new \Symfony\Component\Serializer\Encoder\XmlEncoder())), 1 => ($this->privates['serializer.encoder.json'] ?? ($this->privates['serializer.encoder.json'] = new \Symfony\Component\Serializer\Encoder\JsonEncoder())), 2 => ($this->privates['serializer.encoder.yaml'] ?? ($this->privates['serializer.encoder.yaml'] = new \Symfony\Component\Serializer\Encoder\YamlEncoder())), 3 => ($this->privates['serializer.encoder.csv'] ?? ($this->privates['serializer.encoder.csv'] = new \Symfony\Component\Serializer\Encoder\CsvEncoder())), 4 => ($this->privates['api_platform.jsonld.encoder'] ?? ($this->privates['api_platform.jsonld.encoder'] = new \ApiPlatform\Core\Serializer\JsonEncoder('jsonld'))), 5 => ($this->privates['api_platform.problem.encoder'] ?? ($this->privates['api_platform.problem.encoder'] = new \ApiPlatform\Core\Serializer\JsonEncoder('jsonproblem')))]);
    }
    ...
    {
        return $this->privates['api_platform.cache.identifiers_extractor.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('qlp7HBp8wm', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.property.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('J7l8kI7t9C', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('F46FYi5kL7', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.route_name_resolver.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('6kcrE+CMpM', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    protected function getApiPlatform_FilterLocatorService()
    {
        return $this->privates['api_platform.filter_locator'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'annotated_app_entity_assignment_api_platform_core_bridge_doctrine_orm_filter_order_filter' => ['privates', 'annotated_app_entity_assignment_api_platform_core_bridge_doctrine_orm_filter_order_filter', 'getAnnotatedAppEntityAssignmentApiPlatformCoreBridgeDoctrineOrmFilterOrderFilterService.php', true],
            'annotated_app_entity_crop_api_platform_core_bridge_doctrine_orm_filter_order_filter' => ['privates', 'annotated_app_entity_crop_api_platform_core_bridge_doctrine_orm_filter_order_filter', 'getAnnotatedAppEntityCropApiPlatformCoreBridgeDoctrineOrmFilterOrderFilterService.php', true],
            'annotated_app_entity_customer_api_platform_core_bridge_doctrine_orm_filter_order_filter' => ['privates', 'annotated_app_entity_customer_api_platform_core_bridge_doctrine_orm_filter_order_filter', 'getAnnotatedAppEntityCustomerApiPlatformCoreBridgeDoctrineOrmFilterOrderFilterService.php', true],
            'annotated_app_entity_farm_api_platform_core_bridge_doctrine_orm_filter_order_filter' => ['privates', 'annotated_app_entity_farm_api_platform_core_bridge_doctrine_orm_filter_order_filter', 'getAnnotatedAppEntityFarmApiPlatformCoreBridgeDoctrineOrmFilterOrderFilterService.php', true],
            'annotated_app_entity_greenhouse_api_platform_core_bridge_doctrine_orm_filter_order_filter' => ['privates', 'annotated_app_entity_greenhouse_api_platform_core_bridge_doctrine_orm_filter_order_filter', 'getAnnotatedAppEntityGreenhouseApiPlatformCoreBridgeDoctrineOrmFilterOrderFilterService.php', true],
            'annotated_app_entity_harvest_api_platform_core_bridge_doctrine_orm_filter_order_filter' => ['privates', 'annotated_app_entity_harvest_api_platform_core_bridge_doctrine_orm_filter_order_filter', 'getAnnotatedAppEntityHarvestApiPlatformCoreBridgeDoctrineOrmFilterOrderFilterService.php', true],
            'annotated_app_entity_order_api_platform_core_bridge_doctrine_orm_filter_order_filter' => ['privates', 'annotated_app_entity_order_api_platform_core_bridge_doctrine_orm_filter_order_filter', 'getAnnotatedAppEntityOrderApiPlatformCoreBridgeDoctrineOrmFilterOrderFilterService.php', true],
            'annotated_app_entity_order_item_api_platform_core_bridge_doctrine_orm_filter_order_filter' => ['privates', 'annotated_app_entity_order_item_api_platform_core_bridge_doctrine_orm_filter_order_filter', 'getAnnotatedAppEntityOrderItemApiPlatformCoreBridgeDoctrineOrmFilterOrderFilterService.php', true],
            'annotated_app_entity_phase_api_platform_core_bridge_doctrine_orm_filter_order_filter' => ['privates', 'annotated_app_entity_phase_api_platform_core_bridge_doctrine_orm_filter_order_filter', 'getAnnotatedAppEntityPhaseApiPlatformCoreBridgeDoctrineOrmFilterOrderFilterService.php', true],
            'annotated_app_entity_pollinate_api_platform_core_bridge_doctrine_orm_filter_order_filter' => ['privates', 'annotated_app_entity_pollinate_api_platform_core_bridge_doctrine_orm_filter_order_filter', 'getAnnotatedAppEntityPollinateApiPlatformCoreBridgeDoctrineOrmFilterOrderFilterService.php', true],
            'annotated_app_entity_progression_api_platform_core_bridge_doctrine_orm_filter_order_filter' => ['privates', 'annotated_app_entity_progression_api_platform_core_bridge_doctrine_orm_filter_order_filter', 'getAnnotatedAppEntityProgressionApiPlatformCoreBridgeDoctrineOrmFilterOrderFilterService.php', true],
            'annotated_app_entity_sheet_api_platform_core_bridge_doctrine_orm_filter_order_filter' => ['privates', 'annotated_app_entity_sheet_api_platform_core_bridge_doctrine_orm_filter_order_filter', 'getAnnotatedAppEntitySheetApiPlatformCoreBridgeDoctrineOrmFilterOrderFilterService.php', true],
            'annotated_app_entity_sowing_api_platform_core_bridge_doctrine_orm_filter_order_filter' => ['privates', 'annotated_app_entity_sowing_api_platform_core_bridge_doctrine_orm_filter_order_filter', 'getAnnotatedAppEntitySowingApiPlatformCoreBridgeDoctrineOrmFilterOrderFilterService.php', true],
            'annotated_app_entity_transplant_api_platform_core_bridge_doctrine_orm_filter_order_filter' => ['privates', 'annotated_app_entity_transplant_api_platform_core_bridge_doctrine_orm_filter_order_filter', 'getAnnotatedAppEntityTransplantApiPlatformCoreBridgeDoctrineOrmFilterOrderFilterService.php', true],
            'annotated_app_entity_unit_api_platform_core_bridge_doctrine_orm_filter_order_filter' => ['privates', 'annotated_app_entity_unit_api_platform_core_bridge_doctrine_orm_filter_order_filter', 'getAnnotatedAppEntityUnitApiPlatformCoreBridgeDoctrineOrmFilterOrderFilterService.php', true],
            ...
            'annotated_app_entity_variety_api_platform_core_bridge_doctrine_orm_filter_order_filter' => ['privates', 'annotated_app_entity_variety_api_platform_core_bridge_doctrine_orm_filter_order_filter', 'getAnnotatedAppEntityVarietyApiPlatformCoreBridgeDoctrineOrmFilterOrderFilterService.php', true],
        ], [
            'annotated_app_entity_assignment_api_platform_core_bridge_doctrine_orm_filter_order_filter' => '?',
            'annotated_app_entity_crop_api_platform_core_bridge_doctrine_orm_filter_order_filter' => '?',
            'annotated_app_entity_customer_api_platform_core_bridge_doctrine_orm_filter_order_filter' => '?',
            'annotated_app_entity_farm_api_platform_core_bridge_doctrine_orm_filter_order_filter' => '?',
            'annotated_app_entity_greenhouse_api_platform_core_bridge_doctrine_orm_filter_order_filter' => '?',
            'annotated_app_entity_harvest_api_platform_core_bridge_doctrine_orm_filter_order_filter' => '?',
            'annotated_app_entity_order_api_platform_core_bridge_doctrine_orm_filter_order_filter' => '?',
            'annotated_app_entity_order_item_api_platform_core_bridge_doctrine_orm_filter_order_filter' => '?',
            'annotated_app_entity_phase_api_platform_core_bridge_doctrine_orm_filter_order_filter' => '?',
            'annotated_app_entity_pollinate_api_platform_core_bridge_doctrine_orm_filter_order_filter' => '?',
            'annotated_app_entity_progression_api_platform_core_bridge_doctrine_orm_filter_order_filter' => '?',
            'annotated_app_entity_sheet_api_platform_core_bridge_doctrine_orm_filter_order_filter' => '?',
            'annotated_app_entity_sowing_api_platform_core_bridge_doctrine_orm_filter_order_filter' => '?',
            'annotated_app_entity_transplant_api_platform_core_bridge_doctrine_orm_filter_order_filter' => '?',
            'annotated_app_entity_unit_api_platform_core_bridge_doctrine_orm_filter_order_filter' => '?',
            ...
            'annotated_app_entity_variety_api_platform_core_bridge_doctrine_orm_filter_order_filter' => '?',
        ]);
    }
    ...
    {
        return $this->privates['cache.annotations.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Nx6YQDb3hr', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        $this->privates['cache.app.recorder_inner'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('TTuNnGK3Nf', 0, ($this->targetDirs[0].'/pools'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL))));
    ...
    {
        $this->privates['cache.messenger.restart_workers_signal.recorder_inner'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('fJNUlAAzuc', 0, ($this->targetDirs[0].'/pools'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL))));
    ...
    {
        return $this->privates['cache.property_info.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('eG1653nxTa', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ypQn2+tnAC', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['cache.serializer.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('eXMOYZHVDo', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['cache.system.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('K+x6+esDSq', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['cache.validator.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('74RDJhWWdf', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnection_EventManagerService()
    {
        ...
        $instance->addEventSubscriber(($this->privates['stof_doctrine_extensions.listener.timestampable'] ?? $this->getStofDoctrineExtensions_Listener_TimestampableService()));
        $instance->addEventSubscriber(($this->privates['stof_doctrine_extensions.listener.blameable'] ?? $this->getStofDoctrineExtensions_Listener_BlameableService()));
    ...
    protected function getDoctrine_Orm_ContainerRepositoryFactoryService()
    {
        return $this->privates['doctrine.orm.container_repository_factory'] = new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Repository\\AssignmentRepository' => ['privates', 'App\\Repository\\AssignmentRepository', 'getAssignmentRepositoryService.php', true],
            'App\\Repository\\CropRepository' => ['privates', 'App\\Repository\\CropRepository', 'getCropRepositoryService.php', true],
            'App\\Repository\\CustomerRepository' => ['privates', 'App\\Repository\\CustomerRepository', 'getCustomerRepositoryService.php', true],
            'App\\Repository\\FarmRepository' => ['privates', 'App\\Repository\\FarmRepository', 'getFarmRepositoryService.php', true],
            'App\\Repository\\GreenhouseRepository' => ['privates', 'App\\Repository\\GreenhouseRepository', 'getGreenhouseRepositoryService.php', true],
            'App\\Repository\\HarvestRepository' => ['privates', 'App\\Repository\\HarvestRepository', 'getHarvestRepositoryService.php', true],
            'App\\Repository\\OrderItemRepository' => ['privates', 'App\\Repository\\OrderItemRepository', 'getOrderItemRepositoryService.php', true],
            'App\\Repository\\OrderRepository' => ['privates', 'App\\Repository\\OrderRepository', 'getOrderRepositoryService.php', true],
            'App\\Repository\\PhaseRepository' => ['privates', 'App\\Repository\\PhaseRepository', 'getPhaseRepositoryService.php', true],
            'App\\Repository\\PollinateRepository' => ['privates', 'App\\Repository\\PollinateRepository', 'getPollinateRepositoryService.php', true],
            'App\\Repository\\ProgressionRepository' => ['privates', 'App\\Repository\\ProgressionRepository', 'getProgressionRepositoryService.php', true],
            'App\\Repository\\SheetRepository' => ['privates', 'App\\Repository\\SheetRepository', 'getSheetRepositoryService.php', true],
            'App\\Repository\\SowingRepository' => ['privates', 'App\\Repository\\SowingRepository', 'getSowingRepositoryService.php', true],
            'App\\Repository\\TransplantRepository' => ['privates', 'App\\Repository\\TransplantRepository', 'getTransplantRepositoryService.php', true],
            'App\\Repository\\UnitRepository' => ['privates', 'App\\Repository\\UnitRepository', 'getUnitRepositoryService.php', true],
            'App\\Repository\\UserRepository' => ['privates', 'App\\Repository\\UserRepository', 'getUserRepositoryService.php', true],
            'App\\Repository\\VarietyRepository' => ['privates', 'App\\Repository\\VarietyRepository', 'getVarietyRepositoryService.php', true],
        ], [
            'App\\Repository\\AssignmentRepository' => '?',
            'App\\Repository\\CropRepository' => '?',
            'App\\Repository\\CustomerRepository' => '?',
            'App\\Repository\\FarmRepository' => '?',
            'App\\Repository\\GreenhouseRepository' => '?',
            'App\\Repository\\HarvestRepository' => '?',
            'App\\Repository\\OrderItemRepository' => '?',
            'App\\Repository\\OrderRepository' => '?',
            'App\\Repository\\PhaseRepository' => '?',
            'App\\Repository\\PollinateRepository' => '?',
            'App\\Repository\\ProgressionRepository' => '?',
            'App\\Repository\\SheetRepository' => '?',
            'App\\Repository\\SowingRepository' => '?',
            'App\\Repository\\TransplantRepository' => '?',
            'App\\Repository\\UnitRepository' => '?',
            'App\\Repository\\UserRepository' => '?',
            'App\\Repository\\VarietyRepository' => '?',
        ]));
    }
    ...
    protected function getValidator_ValidatorFactoryService()
    {
        return $this->privates['validator.validator_factory'] = new \Symfony\Component\Validator\ContainerConstraintValidatorFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'App\\Validator\\Constraints\\RolesConstraintValidator' => ['privates', 'App\\Validator\\Constraints\\RolesConstraintValidator', 'getRolesConstraintValidatorService.php', true],
            ...
            'App\\Validator\\Constraints\\RolesConstraintValidator' => '?',
