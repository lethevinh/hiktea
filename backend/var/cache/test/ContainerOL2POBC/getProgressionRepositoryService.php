...
// Returns the private 'App\Repository\ProgressionRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ProgressionRepository.php';

return $this->privates['App\Repository\ProgressionRepository'] = new \App\Repository\ProgressionRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
