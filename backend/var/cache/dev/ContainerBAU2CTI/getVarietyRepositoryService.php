...
// Returns the private 'App\Repository\VarietyRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/VarietyRepository.php';

return $this->privates['App\\Repository\\VarietyRepository'] = new \App\Repository\VarietyRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
