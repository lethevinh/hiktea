...
// Returns the private 'App\Repository\PhaseRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/PhaseRepository.php';

return $this->privates['App\Repository\PhaseRepository'] = new \App\Repository\PhaseRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
