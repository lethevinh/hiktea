...
// Returns the private 'App\Repository\TransplantRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/TransplantRepository.php';

return $this->privates['App\Repository\TransplantRepository'] = new \App\Repository\TransplantRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
