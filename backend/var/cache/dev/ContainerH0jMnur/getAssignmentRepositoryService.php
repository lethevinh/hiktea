...
// Returns the private 'App\Repository\AssignmentRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/AssignmentRepository.php';

return $this->privates['App\Repository\AssignmentRepository'] = new \App\Repository\AssignmentRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
