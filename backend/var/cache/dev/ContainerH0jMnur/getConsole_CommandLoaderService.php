...
}, 'lexik_jwt_authentication.check_config_command' => function (): \Lexik\Bundle\JWTAuthenticationBundle\Command\CheckConfigCommand {
    return ($this->services['lexik_jwt_authentication.check_config_command'] ?? $this->load('getLexikJwtAuthentication_CheckConfigCommandService.php'));
}, 'lexik_jwt_authentication.generate_token_command' => function (): \Lexik\Bundle\JWTAuthenticationBundle\Command\GenerateTokenCommand {
    return ($this->services['lexik_jwt_authentication.generate_token_command'] ?? $this->load('getLexikJwtAuthentication_GenerateTokenCommandService.php'));
