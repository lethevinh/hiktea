...
// Returns the private 'App\Repository\HarvestRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/HarvestRepository.php';

return $this->privates['App\\Repository\\HarvestRepository'] = new \App\Repository\HarvestRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
