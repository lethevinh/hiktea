...
// Returns the private 'App\Repository\CropRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/CropRepository.php';

return $this->privates['App\\Repository\\CropRepository'] = new \App\Repository\CropRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
