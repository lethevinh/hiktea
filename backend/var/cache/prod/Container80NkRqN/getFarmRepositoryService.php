...
// Returns the private 'App\Repository\FarmRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/FarmRepository.php';

return $this->privates['App\Repository\FarmRepository'] = new \App\Repository\FarmRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
