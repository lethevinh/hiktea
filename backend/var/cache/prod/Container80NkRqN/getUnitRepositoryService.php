...
// Returns the private 'App\Repository\UnitRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/UnitRepository.php';

return $this->privates['App\Repository\UnitRepository'] = new \App\Repository\UnitRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
