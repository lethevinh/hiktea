...
// Returns the private 'App\Repository\SheetRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/SheetRepository.php';

return $this->privates['App\Repository\SheetRepository'] = new \App\Repository\SheetRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
