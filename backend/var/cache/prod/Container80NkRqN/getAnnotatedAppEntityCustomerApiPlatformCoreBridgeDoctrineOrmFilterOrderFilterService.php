...
// Returns the private 'annotated_app_entity_customer_api_platform_core_bridge_doctrine_orm_filter_order_filter' shared autowired service.
...
return $this->privates['annotated_app_entity_customer_api_platform_core_bridge_doctrine_orm_filter_order_filter'] = new \ApiPlatform\Core\Bridge\Doctrine\Orm\Filter\OrderFilter(($this->services['doctrine'] ?? $this->getDoctrineService()), NULL, 'order', ($this->privates['logger'] ?? $this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger()), array('id' => NULL));
