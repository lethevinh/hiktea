...
// Returns the private 'App\Repository\PollinateRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/PollinateRepository.php';

return $this->privates['App\Repository\PollinateRepository'] = new \App\Repository\PollinateRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
