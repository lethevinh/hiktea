...
// Returns the private 'App\Repository\SowingRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/SowingRepository.php';

return $this->privates['App\Repository\SowingRepository'] = new \App\Repository\SowingRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
