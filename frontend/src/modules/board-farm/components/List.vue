  ...
  <section>
    <b-table :data="data" :loading="isLoading">
      <template slot-scope="props">
        ...
        <b-table-column field="code" label="Unit">
          <span class="tag is-text" v-if="props.row.unit">
            {{ props.row.unit }}
          </span>
        </b-table-column>
        ...
        <b-table-column width="200" label="">
          <b-taglist>
            <a class="button tag" @click="edit(props.row)" v-if="props.row.status === 'pending'">
              Approve
            </a>
          </b-taglist>
        </b-table-column>
    ...
    <b-modal :active="isFormActive" :onCancel="unedit">
      <div class="modal-card" style="width: auto">
        <header class="modal-card-head">
          <p class="modal-card-title">Approve Report</p>
        </header>
